function [realCost, realOF, time, basis_new]=CplexLPSub(A_mat,b,c,l,u,basis,T)
% 只求一个子问题
...
for testtime = 1:N
    ...
    cplex.Param.simplex.display.Cur = 1;
...
%     basis_new(T(basind)) = 0;
    ...
    basis_new(Indup_rest) = 1;
    xx = -ones(m,1);
    xx(T) = realOF{1};
    basis_new((xx==u)&(basis_new==-1)) = 1;
