...
class LPManager:
    ...
    def update_subproblem(self) -> None:
        """ Update the sub problem by the information of variables. Fixing variables to bounds and update the right-hand side b."""
    ...
    def get_subx(self, x: np.ndarray) -> np.ndarray:
        ...
        Args:
            x: A solution of the original LP.
        """
    ...
    def update_c(self, c_sub_new: np.ndarray) -> None:
        ...
        Args:
            c_sub_new: The new objective function of the sub problem (perturbation added to the sub LP).
        """
    ...
    def fix_constraints(self, ind_fix_to_up: np.ndarray) -> None:
        ...
        Args:
            ind_fix_to_up: The indices of constraints to be fixed to upper bounds
        """
